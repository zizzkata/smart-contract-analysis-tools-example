...
contract VeriAuctionTokenForEth is Ownable {
    ...
    function commit() payable external {
        require(msg.value > 0, "VeriAuctionTokenForEth (commit): commitment must be greater than 0");
    ...
    function claim(uint256 amount) external {
        require(auctionFinalized, "VeriAuctionTokenForEth (claim): Auction not finalized yet");
